...
;; Made a few modifications to the above to adjust colors, etc
;; -- JfM
...
(def-doom-theme doom-one-jfm
  ...
  ((bg         '("#282c34" "black"       "black"  ))
   ...
   (selection      "brightblack") ;; and this one...
   (builtin        magenta)
  ...
  (((line-number &override) :foreground base4)
   ...
   ;;;; ivy
   (ivy-current-match :background "brightblack" :distant-foreground base0 :weight 'normal) ;;;;;;;
   ;;;; LaTeX-mode
   (font-latex-math-face :foreground green)
   ;;;; markdown-mode
   (markdown-markup-face :foreground base5)
   (markdown-header-face :foreground grey)
   (markdown-header-face-2 :foreground green)
   (markdown-header-face-3 :foreground yellow)
